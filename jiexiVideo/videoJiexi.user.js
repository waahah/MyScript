...
(function () {
    ...
    var originalInterfaceList = [
        ...
        //--------------------------------------------------------------------------------------
        {name: "线路一",type: "1",url: "https://jx.yaohuaxuan.com/?url="},
        {name: "线路二",type: "1",url: "https://www.5igen.com/dmplayer/player/?url="},
        {name: "线路三",type: "1",url: "https://vip.parwix.com:4433/player/?url="},
        {name: "线路四",type: "1",url: "https://z1.m1907.cn/?jx="},
        //--------------------------------------------------------------------------------------
        //以下为爱优腾等全网视频解析线路：如果不满意接口速度可以适当替换或删除
        //--------------------------------------------------------------------------------------
        {name: "线路一",type: "2",url: "https://www.h8jx.com/jiexi.php?url="},
        {name: "线路二",type: "2",url: "https://z1.m1907.cn/?jx="},
        {name: "线路三",type: "2",url: "https://vip.bljiex.com/?v="},
        {name: "线路四",type: "2",url: "https://jx.youyitv.com/?url="},
        //--------------------------------------------------------------------------------------
    ];;
    ...
    function GMsetValue(name, value) {if (typeof GM_setValue === "function") { GM_setValue(name, value);} else {GM.setValue(name, value); } }
    function GMxmlhttpRequest(obj) {if (typeof GM_xmlhttpRequest === "function") {GM_xmlhttpRequest(obj); } else {GM.xmlhttpRequest(obj);} }
